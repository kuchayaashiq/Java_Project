...
public class NewMember extends javax.swing.JFrame {
    ...
    public NewMember() {
        ...
        try {
          ...
          ResultSet rs = st.executeQuery("select max(id) from members");
          while(rs.next()){
              id = rs.getInt(1);
              id =id+1;
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "06:00AM - 10:00AM", "10:00AM - 01:00PM", "02:00PM - 04:00PM", "04:00PM - 06:00PM", "06:00PM - 08:00PM" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String adhaarnumber = jTextField6.getText();
