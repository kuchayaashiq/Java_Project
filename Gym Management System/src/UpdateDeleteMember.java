...
public class UpdateDeleteMember extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String adhaarnumber = jTextField9.getText();
        String age = jTextField10.getText();
        String amount = jTextField11.getText();
        try {
            Connection con = ConnectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("update members set name=?,mobilenumber=?,email=?,fathername=?,mothername=?,adhaarnumber=?,age=?,amount=? where id=?");
            ps.setString(1, name);
            ps.setString(2, mobilenumber);
            ps.setString(3, email);
            ps.setString(4, fathername);
            ps.setString(5, mothername);
            ps.setString(6, adhaarnumber);
            ps.setString(7, age);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
              ...
              int a = JOptionPane.showConfirmDialog(null, "Do you really want to Delete a Member","select",JOptionPane.YES_NO_OPTION);  
              if(a ==0){
                  String id = jTextField1.getText();
                  try {
                      Connection con = ConnectionProvider.getCon();
                      Statement st = con.createStatement();
                      st.execute("delete from members where '"+id+"'");
